      ...
      <aside className="sidebar">
        <div className="sidebar-header">
          <h2 className="sidebar-title">Courses</h2>
            <button onClick={onAddCourse} className="add-button" title="Add New Course"> + </button>
        </div>
        <div className="sidebar-content">
          <li className={`course-list-item ${selectedCourseId === 'all' ? 'active' : ''}`} onClick={() => onSelectCourse('all')}>
          ...
          {courses.map(course => (
            <li key={course.id} className={`course-list-item ${selectedCourseId === course.id ? 'active' : ''}`}
        ...
        <div className="sidebar-footer">
          <label className="archive-toggle">
            ...
            <span className="toggle-label">Archived Task View</span>
          </label>
        </div>
      </aside>
    );
